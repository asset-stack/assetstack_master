...
import {
  Search, Layers, MapPin, Cpu, AlertTriangle, Sparkles,
...
export default function AssetTree() {
  ...
  // Measure container for proper centering
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      <main className="px-4 sm:px-6 lg:px-8 py-6 max-w-[1480px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-5">
          <div>
            <div className="flex items-center gap-2.5 mb-1">
              <h1 className="text-2xl font-bold text-slate-900">Asset Tree</h1>
              <div className="flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-indigo-500 to-violet-600 rounded-full">
                <Sparkles className="w-3 h-3 text-white" />
                <span className="text-[10px] font-bold text-white tracking-wider">INTERACTIVE</span>
              </div>
            </div>
            <p className="text-sm text-slate-500">Explore your entire asset hierarchy — click nodes to drill down, drag to pan, scroll to zoom</p>
          </div>
        ...
        <p className="text-xs text-slate-400 mt-3 text-center">
          💡 Tip: Click + / − on group nodes to collapse branches • Click asset cards to see details • Drag background to pan • Scroll to zoom
        </p>
      </main>
      ...
      {/* Link styling for react-d3-tree */}
      <style>{`
        .asset-tree-link {
          fill: none;
          stroke: #cbd5e1;
