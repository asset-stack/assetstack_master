...
export default function AlertsPanel({ alerts, onAcknowledge, onResolve }) {
  ...
  return (
    <div className="bg-slate-900/50 rounded-2xl border border-slate-700/50 backdrop-blur-xl overflow-hidden">
      <div className="p-4 border-b border-slate-700/50 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h3 className="text-lg font-semibold text-white">Active Alerts</h3>
          {activeAlerts.length > 0 && (
            <span className="px-2 py-0.5 bg-rose-500/20 text-rose-400 text-xs font-medium rounded-full">
            ...
            alerts.slice(0, 8).map((alert, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={`p-4 border-b border-slate-700/30 ${config.bg} hover:bg-white/5 transition-colors`}
                >
