      ...
      <div className="max-w-[1100px] mx-auto px-5 md:px-8 hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            <Link to="/CommandCenter" className="mt-7 inline-flex items-center gap-1.5 bg-white text-slate-900 px-5 py-3 rounded-lg text-[13px] font-bold hover:bg-slate-100 transition-colors">
              See it on your data <ArrowRight className="w-4 h-4" />
            </Link>
