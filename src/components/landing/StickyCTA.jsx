      ...
      {show && (
        ...
        >
          <div className="pointer-events-auto rounded-full bg-slate-900 text-white shadow-2xl shadow-slate-900/30 px-5 py-2.5 flex items-center gap-3 border border-white/10">
            <span className="hidden sm:inline text-[12px] font-medium text-slate-300">Try with sample data — no signup</span>
            <span className="sm:hidden text-[12px] font-medium text-slate-300">Try AssetStack</span>
            <Link
              to="/CommandCenter"
