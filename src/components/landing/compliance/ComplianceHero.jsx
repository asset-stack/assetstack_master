...
const HERO_IMG =
  'https://media.base44.com/images/public/6a0a6a5d4d043b0e41a16d90/21e58ce44_abstract-ceiling-of-the-daxing-airport-2026-01-07-07-14-49-utc.jpg';
      ...
      <div className="relative z-[4] px-5 md:px-10 pb-12 md:pb-20 max-w-[1480px] w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-[0.9375rem] lg:items-end">
          ...
          >
            ...
            >
              AssetStack combines machine learning, digital twin modelling and real-time data pipelines on an enterprise-grade, audit-ready foundation — designed for the teams procurement signs off.
            </p>
