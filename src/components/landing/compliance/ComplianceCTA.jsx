        ...
        >
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              >
                Experience<br />AssetStack technology.
              </h3>
            </div>
            <div className="lg:justify-self-end">
              <p className="text-white/80 text-[15px] leading-relaxed max-w-md mb-6">
                Discover how AssetStack combines AI, digital twins and infrastructure data on a
                secure, audit-ready platform to deliver predictive intelligence across asset networks.
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="/Product">
                  ...
                  >
                    Platform modules <ArrowRight className="w-4 h-4 ml-1.5" />
                  </Button>
                </a>
                <a
                  href="/SecurityDocs"
