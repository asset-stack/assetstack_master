        ...
        >
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              >
                Bring your asset portfolio<br />into one intelligence layer.
              </h3>
            </div>
            <div className="lg:justify-self-end">
              <p className="text-white/80 text-[15px] leading-relaxed max-w-md mb-6">
                Book a 30-minute demo and we'll show you how AssetStack
                consolidates your inspections, sensors and registries into
                predictive insight — using your data.
              </p>
