      ...
      <div className="relative z-[4] px-5 md:px-10 pb-12 md:pb-20 max-w-[1480px] w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-[0.9375rem] lg:items-end">
          <div className="lg:col-span-9 overflow-hidden lg:self-end lg:-mb-[0.18em] lg:translate-y-24">
            ...
            >
              Built for the people<br />who maintain the world.
            </h1>
          </div>
          ...
          >
            ...
            >
              AssetStack is an Australian-built operating system for physical infrastructure — engineered with the engineers, councils and operators who run it.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/Contact">
                ...
                >
                  Talk to the team <ArrowRight className="w-4 h-4 ml-1.5" />
                </Button>
              </a>
              <a
                href="/Product"
