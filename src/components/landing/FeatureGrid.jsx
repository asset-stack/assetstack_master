...
const features = [
  {
    icon: Camera, color: 'from-primary to-blue-400',
  ...
  return (
    <section id="features" className="py-20 md:py-28 bg-slate-50/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Capabilities</span>
