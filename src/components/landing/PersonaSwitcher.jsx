    ...
    <section id="persona" className="py-20 md:py-28 bg-white border-y border-slate-100">
      <div className="max-w-[1280px] mx-auto px-5 md:px-8">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-[15px] md:text-base text-slate-600 max-w-xl mx-auto">Pick how you'll use AssetStackwe'll remember and tailor what you see across the site.
