    ...
    <EditorialShell folio="11" section="Trust">
      <div className="h-full flex flex-col">
          ...
          {COLUMNS.map((c, i) => (
            ...
            >
              <div
                ...
                style={{ background: 'linear-gradient(to right, rgba(168, 85, 247, 0.5), rgba(99, 102, 241, 0.1))' }}
              />
              <div className="text-[10px] tracking-[0.3em] uppercase text-violet-300 mb-4">{c.label}</div>
              <h3
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(to right, rgba(168, 85, 247, 0.4), rgba(99, 102, 241, 0.2), transparent)' }}
        />
